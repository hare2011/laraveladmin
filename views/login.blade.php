...
<head>
  ...
  <title>{{config('admin.title')}} | {{ trans('lang.login') }}</title>
  ...
  <div class="login-box-body">
    ...
    <form action="{{ Admin::url('auth/login') }}" method="post">
      <div class="form-group has-feedback {!! !$errors->has('username') ?: 'has-error' !!}">
        ...
        <input type="input" class="form-control" placeholder="{{ trans('lang.username') }}" name="username" value="{{ old('username') }}">
      ...
      <div class="form-group has-feedback {!! !$errors->has('password') ?: 'has-error' !!}">
        ...
        <input type="password" class="form-control" placeholder="{{ trans('lang.password') }}" name="password" value="{{ old('username') }}">
